        ...
        <div className="sidebar-wrapper">
            ...
            <div className="contact-container container-block">
                <ul className="list-unstyled contact-list">
                    ...
                    <li className="linkedin"><i className="fab fa-linkedin-in"></i><a href="https://www.linkedin.com/in/mohanraj-krishnamoorthy-841877137" target="_blank">linkedin.com/in/mohanraj-krishnamoorthy-841877137</a></li>
